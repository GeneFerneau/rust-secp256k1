...
extern "C" {
    ...
    #[cfg_attr(not(rust_secp_no_symbol_renaming), link_name = "rustsecp256k1_v0_4_0_ec_seckey_cond_negate")]
    pub fn secp256k1_ec_seckey_cond_negate(out: *mut c_uchar,
                                           ins: *const c_uchar)
                                           -> c_int;

    #[cfg_attr(not(rust_secp_no_symbol_renaming), link_name = "rustsecp256k1_v0_4_0_ec_seckey_is_high")]
    pub fn secp256k1_ec_seckey_is_high(ret: *mut i32,
                                       sk: *const c_uchar)
                                       -> c_int;
    ...
    #[cfg_attr(not(rust_secp_no_symbol_renaming), link_name = "rustsecp256k1_v0_4_0_ec_pubkey_cond_negate")]
    pub fn secp256k1_ec_pubkey_cond_negate(cx: *const Context,
                                           pk: *mut PublicKey) -> c_int;
